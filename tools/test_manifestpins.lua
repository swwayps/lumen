...
do
  ...
  -- Regression: a LuaTools date header ("-- 2026-06-12 04:39:06 UTC") must NOT
  -- be read as the appid. The ISO hyphens once matched the YEAR ("2026") as a
  -- header appid, which conflicted with the real appid and failed every add /
  -- import of a normal LuaTools manifest (the LEGO Batman 2215200 body).
  local dated = table.concat({
    "-- LEGO Batman: Legacy of the Dark Knight",
    "-- 2026-06-12 04:39:06 UTC",
    "-- This Lua was generated by LuaTools",
    "addappid(2215200)",
    "addappid(4468750)",
    'addappid(2215201, 1, "' .. key .. '")',
    'setManifestid(2215201, "8744395932724193069")',
  }, "\n")
  local dhint, dhint_err = mp.resolve_lua_identity(dated, { appid = 2215200 })
  check(dhint ~= nil and dhint_err == nil,
    "identity: a date header does not conflict with the real appid")
  eq(dhint and dhint.base, 2215200,
    "identity: the header year is not mistaken for the appid")
  -- The genuine "<appid> - <name>" header is still recognized on its own.
  local headed = mp.resolve_lua_identity(table.concat({
    "-- 3321460 - Crimson Desert",
    'addappid(3321460, 1, "' .. key .. '")',
  }, "\n"), {})
  eq(headed and headed.base, 3321460,
    "identity: a real '<appid> - <name>' header is still read")
end

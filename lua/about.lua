...
--
-- The third About action, "Reload All" (a live Steam-UI JS-context reload, no
-- Steam restart), is NOT here: it needs the injector's SharedJSContext relay, so
-- it's handled as a control command in injector.lua (__lumenRestartJSContext).
--

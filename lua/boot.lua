...
local function build_channels(theme_config, clean_previous)
  ...
  local out = {
    -- Special Offers is an authenticated marketing popup, not a normal Store
    -- webview: parental-only unlock, matched by secure exact origin + path.
    { origins = { { host = "store.steampowered.com",
                    path_prefix = "/marketingmessages/list" } },
      remote = true, browser = true, assets = offers_assets },
    -- Store/community web views: LuaTools webkit frontend + menu + theme layer.
    -- Secure exact-host origin matching (never a substring of a hostile URL).
    { origins = { { host = "store.steampowered.com" },
                  { host = "steamcommunity.com" } },
      remote = true, browser = true, assets = webview_assets },

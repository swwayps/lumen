...
// LM-FRAGMENT by boot.lua (read_menu_js). Not a standalone module. See 01-core.js.
  ...
  function injectStyles() {
    ...
    s.textContent = [
      ...
      ".lumen-auto-fix-overlay{position:fixed;inset:0;z-index:100003;display:flex;align-items:center;justify-content:center;",
      "padding:24px;box-sizing:border-box;background:rgba(0,0,0,.62);font-family:'Motiva Sans',Arial,Helvetica,sans-serif;}",
      ".lumen-auto-fix-modal{width:430px;max-width:92vw;box-sizing:border-box;padding:24px;border:1px solid #414955;",
      "border-radius:8px;background:#25282e;color:#dcdedf;box-shadow:0 18px 50px rgba(0,0,0,.5);}",
      ".lumen-auto-fix-eyebrow{margin-bottom:8px;color:#66c0f4;font-size:11px;font-weight:700;text-transform:uppercase;letter-spacing:.06em;}",
      ".lumen-auto-fix-game{margin:0;color:#fff;font-size:21px;font-weight:700;line-height:1.25;}",
      ".lumen-auto-fix-note{margin:10px 0 22px;color:#aeb4bb;font-size:13px;line-height:1.5;}",
      ".lumen-auto-fix-status-row{display:flex;align-items:center;justify-content:space-between;gap:16px;margin-bottom:9px;",
      "color:#dcdedf;font-size:12px;font-weight:600;}",
      ".lumen-auto-fix-percent{color:#66c0f4;font-variant-numeric:tabular-nums;}",
      ".lumen-auto-fix-track{height:7px;overflow:hidden;border-radius:999px;background:#171a20;}",
      ".lumen-auto-fix-fill{height:100%;width:0;border-radius:inherit;background:#1a9fff;transition:width .24s ease-out;}",
      ".lumen-auto-fix-error{min-height:18px;margin-top:10px;color:#ec7777;font-size:11.5px;line-height:1.4;}",
      ".lumen-auto-fix-actions{display:flex;align-items:center;justify-content:flex-end;flex-wrap:wrap;gap:8px;margin-top:14px;}",
      ".lumen-auto-fix-action{min-height:38px;padding:8px 13px;border:1px solid #4a5663;border-radius:4px;",
      "background:#303640;color:#dcdedf;font:600 12px 'Motiva Sans',Arial,sans-serif;cursor:pointer;}",
      ".lumen-auto-fix-action:hover{background:#3b4350;color:#fff}.lumen-auto-fix-action.primary{background:#1a9fff;border-color:#1a9fff;color:#fff;}",
      ".lumen-auto-fix-action.primary:hover{background:#3cb0ff;border-color:#3cb0ff;}",
      ".lumen-auto-fix-action:focus-visible,.lumen-auto-fix-action.active-focus{outline:2px solid #66c0f4;outline-offset:2px;}",
      ".lumen-auto-fix-action:disabled{opacity:.5;cursor:wait;}",
      ".lumen-install-readiness-overlay{position:fixed;inset:0;z-index:100004;display:flex;align-items:center;justify-content:center;",
      "padding:24px;box-sizing:border-box;background:rgba(0,0,0,.62);font-family:'Motiva Sans',Arial,Helvetica,sans-serif;}",
      ".lumen-install-readiness-modal{width:460px;max-width:92vw;box-sizing:border-box;padding:24px;border:1px solid #414955;",
      "border-radius:8px;background:#25282e;color:#dcdedf;box-shadow:0 18px 50px rgba(0,0,0,.5);}",
      ".lumen-install-readiness-eyebrow{margin-bottom:8px;color:#d6a64c;font-size:11px;font-weight:700;text-transform:uppercase;letter-spacing:.06em;}",
      ".lumen-install-readiness-title{color:#fff;font-size:21px;font-weight:700;line-height:1.25;}",
      ".lumen-install-readiness-body{margin:10px 0 14px;color:#aeb4bb;font-size:13px;line-height:1.5;}",
      ".lumen-install-readiness-risk{margin:0;padding:10px 12px;border-left:3px solid #d6a64c;background:rgba(214,166,76,.08);",
      "color:#d8c7a6;font-size:12px;line-height:1.45;}",
      ".lumen-install-readiness-actions{display:flex;align-items:center;justify-content:flex-end;flex-wrap:wrap;gap:8px;margin-top:20px;}",
      ".lumen-install-readiness-action{min-height:38px;padding:8px 13px;border:1px solid #4a5663;border-radius:4px;",
      "background:#303640;color:#dcdedf;font:600 12px 'Motiva Sans',Arial,sans-serif;cursor:pointer;}",
      ".lumen-install-readiness-action:hover{background:#3b4350;color:#fff}.lumen-install-readiness-action.primary{background:#1a9fff;border-color:#1a9fff;color:#fff;}",
      ".lumen-install-readiness-action.primary:hover{background:#3cb0ff;border-color:#3cb0ff;}",
      ".lumen-install-readiness-action:focus-visible,.lumen-install-readiness-action.active-focus{outline:2px solid #66c0f4;outline-offset:2px;}",
      ".lumen-install-readiness-toast{position:fixed;right:24px;bottom:24px;z-index:100004;max-width:360px;box-sizing:border-box;",
      "padding:13px 16px;border:1px solid #477b43;border-radius:5px;background:#24342a;color:#dcebd8;",
      "box-shadow:0 12px 32px rgba(0,0,0,.42);font:600 12px/1.45 'Motiva Sans',Arial,sans-serif;}",
      "@media (prefers-reduced-motion:reduce){.lumen-auto-fix-pill-copy,.lumen-auto-fix-fill{transition:none!important;}}",

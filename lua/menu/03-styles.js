...
// LM-FRAGMENT by boot.lua (read_menu_js). Not a standalone module. See 01-core.js.
  ...
  function injectStyles() {
    ...
    s.textContent = [
      ...
      ".lumen-channel-card-control{flex:0 0 103px;width:103px;text-align:right;}",
      ".lumen-channel-card-control .lumen-channel{width:100%;height:38px;}",
      ".lumen-channel-card-control .lumen-channel-option{flex:1 1 50%;min-width:0;padding:0;font-size:13px;}",
